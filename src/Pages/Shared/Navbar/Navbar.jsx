    ...
    return (
        ...
        <div className="navbar justify-between rounded-xl mt-4">
            ...
            <div className="navbar-end gap-2 ">
                ...
                {
                    user ?
                        <button onClick={handleSignOut} className='btn btn-primary text-white bg-pink-700 border-pink-700 normal-case'>LogOut</button>
                        :
                        <button className='btn btn-primary text-white bg-pink-700 border-pink-600 normal-case'>
                            <Link to='/login'>Login</Link>
                        </button>
                }
                <MdDarkMode className="text-2xl" onClick={toggleTheme}></MdDarkMode>
                {/* <button onClick={toggleTheme} className="btn btn-outline text-pink-500 border-pink-700 normal-case">
                d
            </button> */}
            </div>
        </div>
