...
const Features = () => {
    return (
        <div className="my-10 py-10 bg-pink-200">
            ...
            <p className=" text-xl text-center text-pink-800 font-medium ">We are serving up trusted insights and anonymous conversation, so you will have the goods you need to succeed.</p>
