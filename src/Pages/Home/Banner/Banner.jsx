...
const Banner = () => {
    ...
    return (
        ...
        //     </div>
        //   </div>
        <div data-aos="zoom-in" className="hero min-h-screen mb-10" style={{ backgroundImage: 'url(https://i.ibb.co/2yvwVyp/coins-job-word.jpg)' }}>
            <div className="hero-overlay bg-opacity-20"></div>
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-xl">
                    <h1 className="text-5xl text-pink-900 font-bold">Unlock Your Career Potential with JobHunt</h1>
                    <p className="my-4 text-pink-800 text-lg">Discover your dream job with JobHunt, personalized recommendations, and expert guidance. Your next opportunity is just a click away!</p>
